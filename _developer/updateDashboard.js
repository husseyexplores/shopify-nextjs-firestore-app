...
console.log(
  '--> Fetching App Data. App Client ID =>',
  `"${env.NEXT_PUBLIC_SHOPIFY_APP_CLIENT_ID}"`,
)
const app = await getApp(env.NEXT_PUBLIC_SHOPIFY_APP_CLIENT_ID, accessToken)

console.log(
  '--> Updating URLs. APP Base URL is =>',
  env.NEXT_PUBLIC_SHOPIFY_APP_URL,
)
await updateDashboardURLs(app.apiKey, env.NEXT_PUBLIC_SHOPIFY_APP_URL)
