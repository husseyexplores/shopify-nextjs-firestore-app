      ...
      <Layout>
        ...
        <Layout.Section oneHalf>
          <LegacyCard
            ...
            title="Product Card"
            primaryFooterAction={{
              content: 'Default product card',
              onAction: () => {
                router.push('/debug/products')
              },
            }}
          >
            <p>As defined here</p>
            <a
              href="https://github.com/Shopify/shopify-frontend-template-react/blob/main/components/ProductsCard.jsx"
              target="_blank"
            >
              https://github.com/Shopify/shopify-frontend-template-react/blob/main/components/ProductsCard.jsx
            </a>
          </LegacyCard>
        </Layout.Section>
      </Layout>
